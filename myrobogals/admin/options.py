...
from myrobogals.admin import helpers, validation, widgets
from myrobogals.admin.checks import (
    BaseModelAdminChecks, InlineModelAdminChecks, ModelAdminChecks,
)
from myrobogals.admin.exceptions import DisallowedModelAdminToField
from myrobogals.admin.templatetags.admin_static import static
from myrobogals.admin.templatetags.admin_urls import add_preserved_filters
from myrobogals.admin.utils import (
    NestedObjects, flatten_fieldsets, get_deleted_objects,
    lookup_needs_distinct, model_format_dict, quote, unquote,
)
from myrobogals.auth import get_permission_codename
...
class BaseModelAdmin(six.with_metaclass(forms.MediaDefiningClass)):
    ...
    def lookup_allowed(self, lookup, value):
        from myrobogals.admin.filters import SimpleListFilter
