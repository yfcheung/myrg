...
from myrobogals.auth import views as auth_views
...
urlpatterns = [
    ...
    url(r'^chpass/$', auth_views.password_change, {'template_name': 'password_change_form.html'}),
    url(r'^forgotpass/done/$', auth_views.password_reset_done, {'template_name': 'password_reset_done.html'}),
    url(r'^forgotpass/confirm/(?P<uidb36>.+)/(?P<token>.+)/$', auth_views.password_reset_confirm, {'template_name': 'password_reset_confirm.html'}),
    url(r'^forgotpass/complete/$', auth_views.password_reset_complete, {'template_name': 'password_reset_complete.html'}),
    ...
    url(r'^newsletter/(?P<chapterurl>.+)/subscribe/$', rgprofile_views.newslettersub),
    url(r'^newsletter/(?P<chapterurl>.+)/subscribe/done/$', rgprofile_views.newslettersubdone),
    url(r'^newsletter/(?P<chapterurl>.+)/unsubscribe/$', rgprofile_views.newsletterunsub),
    url(r'^newsletter/(?P<chapterurl>.+)/unsubscribe/done/$', rgprofile_views.newsletterunsubdone),
