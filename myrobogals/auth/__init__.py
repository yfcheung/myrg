...
def get_user(request):
    ...
    try:
        ...
        if backend_path in settings.AUTHENTICATION_BACKENDS:
            ...
            # Verify the session
            if ('myrobogals.auth.middleware.SessionAuthenticationMiddleware'
...
def update_session_auth_hash(request, user):
    ...
    myrobogals.auth.middleware.SessionAuthenticationMiddleware is enabled.
...
default_app_config = 'myrobogals.auth.apps.AuthConfig'
