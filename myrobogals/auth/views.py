...
from django.utils.http import is_safe_url, urlsafe_base64_decode, base36_to_int
...
def unsubscribe(request, uidb36, token, step):
    if step == '1':
        ...
        hash2 = sha_constructor(user.id + ts).hexdigest()[::2]
        ...
        if form.is_valid():
            ...
            if is_admin_site:
                warnings.warn(
                    ...
                    "myrobogals.auth.views.password_reset() is deprecated "
...
def password_change(request,
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            request.user.message_set.create(message=_("Password changed"))
